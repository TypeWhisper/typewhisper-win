...
```powershell
dotnet msbuild plugins/TypeWhisper.Plugin.Script/portable.proj /t:Build /p:Configuration=Release
dotnet test plugins/TypeWhisper.Plugin.Script/Tests -c Release
```
