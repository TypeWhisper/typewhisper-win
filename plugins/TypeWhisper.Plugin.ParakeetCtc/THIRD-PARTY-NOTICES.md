...
This is an experimental Windows CTC adapter, not a claim of numerical or behavioral equivalence to FluidAudio's CoreML rescorer. Verify actual model emissions before connecting it to final dictation. The model is English; multilingual vocabulary behavior requires separate validation.
