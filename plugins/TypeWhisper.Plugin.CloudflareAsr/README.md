...
```powershell
dotnet test plugins/TypeWhisper.Plugin.CloudflareAsr/Tests/TypeWhisper.Plugin.CloudflareAsr.Portable.Tests.csproj -c Release
dotnet msbuild plugins/TypeWhisper.Plugin.CloudflareAsr/portable.proj '-t:Build;CopyPackage' -p:Configuration=Release -p:PluginDestination=<staging-directory>
```
