...
```powershell
dotnet msbuild plugins/TypeWhisper.Plugin.SupertonicTts/portable.proj /t:Build /p:Configuration=Release
dotnet test plugins/TypeWhisper.Plugin.SupertonicTts/Tests -c Release
```
