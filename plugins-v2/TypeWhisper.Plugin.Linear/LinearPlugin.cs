...
public sealed partial class LinearPlugin : IActionPlugin, IApiKeyPlugin, IPluginTextSettings
{
    ...
    /// <inheritdoc />
    public bool IsConfigured => Connection.Configured && !string.IsNullOrWhiteSpace(Connection.Get("teamId"));
    /// <inheritdoc />
