...
/// </summary>
public sealed partial class XaiPlugin : ITranscriptionEnginePlugin, ILlmProviderPlugin, ILlmRequestHedgingSupport, ITtsProviderPlugin
{
    ...
    {
        _host?.SetSetting(SelectedModelSettingName, NormalizeSttModelId(modelId));
    ...
    {
        _host?.SetSetting(CustomVoiceIdSettingName, voiceId.Trim());
