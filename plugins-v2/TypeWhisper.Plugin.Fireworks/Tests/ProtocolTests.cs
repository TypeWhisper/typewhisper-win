...
{Assert.Equal("audio-prod.api.fireworks.ai",request.RequestUri!.Host); Assert.Equal("Bearer",request.Headers.Authorization!.Scheme);return Json("""{"text":"Hallo Welt","language":"de"}""");}
