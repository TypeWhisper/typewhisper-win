...
public sealed partial class ProviderTests
{
    ...
    public async Task PackageInstallsLoadsRestartsAndReinstallsIndependently()
    {
        ...
        try
        {
            ...
            var entry=new PortableCatalogEntry{Id=Id,Name="CloudflareAsr",Version="1.1.1",MinHostVersion="1.1.2",DownloadUrl="https://fixture.invalid/plugin.zip",Sha256=Convert.ToHexString(SHA256.HashData(bytes)),Size=bytes.Length,SupportedArchitectures=[PortablePluginCatalog.Architecture]};
