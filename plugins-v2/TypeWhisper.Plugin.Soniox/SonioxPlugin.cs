...
/// </summary>
public sealed partial class SonioxPlugin : ITranscriptionEnginePlugin
{
    ...
    private static HttpClient CreateHttpClient() => new(new HttpClientHandler { AllowAutoRedirect = false }) { Timeout = TimeSpan.FromMinutes(5) };
