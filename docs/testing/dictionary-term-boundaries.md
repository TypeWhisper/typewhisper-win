...
Local validation: 603 provider tests passed across the eight affected packages, plus 282 portable SDK/host tests. Package compatibility cases were rerun after raising the minimum host contract to 1.1.5.
