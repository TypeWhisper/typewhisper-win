...
Latest verified CI at `f8e25ec`: [headless run 34136907550](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34136907550) passed on [Windows](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34136907550/job/101789904775) and [Ubuntu](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34136907550/job/101789904471). [CodeQL run 34136908414](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34136908414) passed for [C#](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34136908414/job/101789910947), [JavaScript](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34136908414/job/101789911109) and [Python](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34136908414/job/101789911299). These statuses were verified against the commit; no counts are inferred. CodeRabbit still skips draft review. CI for `472a3f6` has not yet started.

Current implementation checkpoint: `472a3f6` (2026-09-07), including Recovery UI fix `108a67c`, Review action wiring `e1588aa`, persistent Cancel shortcut `b359c5a`, the initialized Review fixture `d333cb6`, plugin field layout `64dcf8d`, local spoken feedback `ff3c44b`, launcher status reporting `2879b6e`, portable model operations `bea6c08`, multiline field fixes `76c4505` and generic model UI/Session integration `3d80de1`. Release-wide draft: [PR #447](https://github.com/TypeWhisper/typewhisper-win/pull/447), `seofood/release-1.1` against `main`.
