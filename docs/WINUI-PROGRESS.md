...
Latest verified CI is for `aaf71c3ad2ad75bfcfc6144c03ebde7a789ca0aa`: [headless run 34138471611](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34138471611) passed on [Windows](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34138471611/job/101794824935) and [Ubuntu](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34138471611/job/101794825163). [CodeQL run 34138472601](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34138472601) passed for [C#](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34138472601/job/101794831790), [JavaScript](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34138472601/job/101794831768) and [Python](https://github.com/TypeWhisper/typewhisper-win/actions/runs/34138472601/job/101794831572). Every listed job was verified against that exact History checkpoint. No suite counts are inferred from CI statuses. CodeRabbit skipped draft review.

Current committed implementation checkpoint: `d55ec0d` (2026-09-07), including Recovery UI fix `108a67c`, Review action wiring `e1588aa`, persistent Cancel shortcut `b359c5a`, the initialized Review fixture `d333cb6`, plugin field layout `64dcf8d`, local spoken feedback `ff3c44b`, launcher status reporting `2879b6e`, portable model operations `bea6c08`, multiline field fixes `76c4505` and generic model UI/Session integration `3d80de1`. Release-wide draft: [PR #447](https://github.com/TypeWhisper/typewhisper-win/pull/447), `seofood/release-1.1` against `main`.
