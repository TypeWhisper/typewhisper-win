...
- Smaller installer: removed unused WPF and host AI runtimes and duplicate CLI runtime files. The optional CLI installation still produces a complete standalone tool.
