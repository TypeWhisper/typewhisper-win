...
| Cohere | Independent portable package 1.1.1 with 34 passing tests, branding and shared settings save. Authenticated transcription and text processing passed; German microphone dictation accepted. No realtime audio API is advertised. See plugin README. |
