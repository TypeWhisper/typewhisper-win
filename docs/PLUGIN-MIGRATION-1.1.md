...
| SupertonicTts | Independent v2 package 1.2.1; 18 plugin tests and native German M1/F1 synthesis, cancellation and reload pass. License checkbox, model download/load progress, provider icon and shared speech settings prepared. Joint Windows UI/audio acceptance with Gemma, screenshot and publication pending. See plugin README. |
