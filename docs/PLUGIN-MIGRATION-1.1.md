...
| Cohere | Independent v2 implementation in `plugins-v2/TypeWhisper.Plugin.Cohere`; provider, settings and immutable-package lifecycle tests included. Compared with macOS; scope differences and pending live acceptance are documented in the plugin README. |
