...
| OpenRouter | Independent v2 implementation in `plugins-v2/TypeWhisper.Plugin.OpenRouter`; protocol/settings and isolated package lifecycle tests pass. Development UI inspected; authenticated live acceptance, update acceptance and publication pending (see plugin README). |
