...
| WhisperCpp | Whisper (Local) 1.2.10 in `plugins-v2/TypeWhisper.Plugin.WhisperCpp`; 73 plugin tests pass. CUDA Large V3 Turbo, local live preview, restart loading, shared settings, chip icon and German microphone dictation verified on installed 1.2.4; UI screenshots remain from 1.2.4. Source 1.2.10 has regression coverage. Public package/catalog publication pending. See the plugin README for platform differences. |
