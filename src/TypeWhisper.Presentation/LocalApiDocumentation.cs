...
internal static class LocalApiDocumentation
{
    ...
    private const string Html = """
        ...
        <li><code>target_language</code>: translate through the Windows default workflow LLM configuration. Timed segments are also translated in batches while keeping the provider timestamps. The main text retains whole-transcript context and formatting. Invalid segment alignment returns 502 instead of source-language subtitles. Missing default LLM configuration returns 422. This does not use the macOS Translation framework.</li></ul>
