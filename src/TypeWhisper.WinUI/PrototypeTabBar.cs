...
internal sealed record PrototypeTab(string Id, string Label);

/// <summary>Shared, left-aligned section tabs with a single keyboard entry point.</summary>
public sealed class PrototypeTabBar : UserControl
{
    ...
    internal void SetItems(IReadOnlyList<PrototypeTab> tabs, string selectedId)
    {
