...
public sealed partial class MainWindow
{
    ...
    internal void FreezeForProfileRestore()
    {
        ...
        _profileUiDrain = Task.WhenAll(WinUILicensing.ShutdownAsync(), _httpApi.ShutdownAsync(), workflowShortcuts, HistoryView.ShutdownAsync(), WorkflowsView.ShutdownAsync(),
