...
internal sealed class Lexicon
{
    ...
    internal Lexicon(string? dictionaryPath = null, string? snippetPath = null)
    {
    ...
    private void RefreshSnippets()
    {
        ...
        _entries.AddRange(_snippets.Snippets.Select(e => new LexiconEntry(UiId(e.Id),
            LexiconKind.Snippet, e.Trigger, e.Replacement, e.Tags, e.CaseSensitive, e.IsEnabled, UsageCount: e.UsageCount)));
    }
    ...
    internal bool Remove(Guid id)
    {
        ...
        if (entry.Kind == LexiconKind.Snippet && _snippets is not null)
        {
            try
            {
