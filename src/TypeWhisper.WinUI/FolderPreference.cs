...
public sealed class FolderPreference : UserControl
{
    internal FolderPreference(string key, string label, string value, Dictionary<string, string> values)
    {
        ...
        var input = new TextBox
        {
            ...
            Style = (Style)Application.Current.Resources["SearchTextBoxStyle"]
        };
