...
public sealed class PrototypeShortcutRecorder : UserControl
{
    ...
    private string? Validate(string candidate) => PrototypeShortcutRules.Validate(candidate, allowModifiersOnly: _key is not ("CancelProcessingHotkeys" or "WorkflowSelectedTextHotkeys" or "RecentTranscriptionsHotkeys" or "CopyLastTranscriptionHotkeys" or "ReadLastTranscriptionHotkeys"))
