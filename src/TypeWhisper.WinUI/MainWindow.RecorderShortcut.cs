...
public sealed partial class MainWindow
{
    ...
    private string? ValidateRecorderShortcut(string value)
    {
        ...
        return RecordingShortcutConflict(value) ?? WorkflowPaletteShortcutConflict(value) ?? HistoryShortcutConflict(value) ?? ReadLastShortcutConflict(value) ?? CopyLastShortcutConflict(value) ?? PasteLastShortcutConflict(value) ?? _workflowShortcuts?.Conflict(value);
    }
