...
internal sealed record ModelOption(string Id, string Title, string Description, string Badge);

// Fictional catalog and in-memory download simulation. No model files or services.
internal sealed class ModelSession(Dictionary<string, string> values)
{
    internal static readonly ModelOption[] Models =
    [
    ...
    private const string InstalledKey = "Models.Downloaded";
