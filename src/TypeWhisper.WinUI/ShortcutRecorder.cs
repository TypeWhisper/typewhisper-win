...
public sealed class ShortcutRecorder : UserControl
{
    ...
    private string? Validate(string candidate) => ShortcutRules.Validate(candidate, allowModifiersOnly: _key is not ("CancelProcessingHotkeys" or "WorkflowSelectedTextHotkeys" or "RecentTranscriptionsHotkeys" or "CopyLastTranscriptionHotkeys" or "ReadLastTranscriptionHotkeys"))
