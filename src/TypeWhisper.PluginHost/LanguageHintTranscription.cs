...
public static class LanguageHintTranscription
{
    ...
    public static Task<PluginTranscriptionResult> DecodeAsync(ITranscriptionEnginePlugin engine,
        ...
        IReadOnlyList<string> preferredLanguages, bool translate, CancellationToken ct, string? prompt = null)
    {
        ...
        if (language is not null || preferredLanguages.Count == 0 || !engine.SupportsLanguageHints)
            return engine is IPcmTranscriptionEnginePlugin pcm
                ...
                : engine.TranscribeAsync(encodeWav(), language, translate, engine.SupportsDictionaryTerms ? prompt : null, ct);
        ...
        return engine.TranscribeWithLanguageHintsAsync(encodeWav(), preferredLanguages, translate, engine.SupportsDictionaryTerms ? prompt : null, ct);
    }
}
