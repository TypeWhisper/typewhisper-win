...
public class HotkeyInputTests
{
    ...
    [Fact]
    public void ModifierOnly_WinAlt_PressWinThenAlt_SwallowsActivationKeyUp()
    {
    ...
    [Fact]
    public void ModifierOnly_CtrlShift_SwallowsActivationKeyUpWhenActivationKeyDownWasSwallowed()
    {
