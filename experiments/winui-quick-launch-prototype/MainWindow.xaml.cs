...
public sealed partial class MainWindow : Window
{
    ...
    internal MainWindow()
    {
        ...
        RecorderView.CompletedEntryChanged += HistoryView.UpsertRecorderEntry;
        ...
        try
        {
            _hotkeyRegistration = new PrototypeHotkeyRegistration(this, () =>
                DispatcherQueue.TryEnqueue(ShowFromHotkey));
