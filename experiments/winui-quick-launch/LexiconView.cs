...
{
    private readonly Lexicon _store = Lexicon.CreateSamples();
    ...
    private void RenderList()
    {
        ...
        foreach (var kind in Enum.GetValues<LexiconKind>())
        {
            var label = kind switch { LexiconKind.Word => "Words", LexiconKind.Correction => "Corrections", _ => "Snippets" };
