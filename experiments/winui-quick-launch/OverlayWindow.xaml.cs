...
public sealed partial class OverlayWindow : Window
{
    ...
    internal void SetLayout(OverlayPreferences preferences) => _layout = preferences;
    ...
    private void ApplyWidgets()
    {
        ...
        RightWidgetText.MaxWidth = _mode == OverlayMode.Compact ? 100 : 150;
    ...
    {
        text.Visibility = widget is OverlayWidget.None or OverlayWidget.Timer or OverlayWidget.Waveform ? Visibility.Collapsed : Visibility.Visible;
        text.Text = widget switch
        {
            OverlayWidget.Clock => DateTime.Now.ToString("HH:mm"),
            OverlayWidget.Profile => "Default profile",
            OverlayWidget.HotkeyMode => "Toggle",
            OverlayWidget.AppName => "Quick Launch",
            OverlayWidget.Indicator => _paused ? "Paused" : "Recording",
            _ => ""
        };
    }
