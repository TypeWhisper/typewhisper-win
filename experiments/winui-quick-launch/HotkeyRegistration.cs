...
internal sealed class HotkeyRegistration : IDisposable
{
    ...
    internal HotkeyRegistration(Microsoft.UI.Xaml.Window window, Action callback)
    {
        ...
        else
        {
            ...
            throw new Win32Exception(Marshal.GetLastWin32Error(), "The preview hotkeys are already assigned.");
        }
