...
New artifact: `AccountView.cs`. Integration: settings catalog and window, MainWindow, App startup `--account`. Open Settings > Account & about, or launch the isolated preview with `--account` after its usual Debug win-x64 build.
