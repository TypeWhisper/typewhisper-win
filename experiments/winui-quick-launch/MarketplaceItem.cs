...
public sealed record MarketplaceItem(Plugin Plugin, string Publisher, bool Trusted = true)
{
    ...
    internal static IReadOnlyList<MarketplaceItem> Samples =>
    [
        ...
        new(Plugin.Samples.First(plugin => plugin.Id == "local"), "TypeWhisper · demo listing"),
        new(Plugin.Samples.First(plugin => plugin.Id == "markdown"), "TypeWhisper · demo listing"),
