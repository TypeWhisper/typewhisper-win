...
internal sealed class AccountView : UserControl
{
    internal AccountView(Dictionary<string, string> values, List<ChoicePicker> pickers)
    {
        ...
        identity.Children.Add(Copy("Windows · WinUI preview", 13, true, true));
        ...
        var licensePicker = new ChoicePicker();
        ...
        void ShowLicense(string id)
        {
            ...
            (licenseTitle.Text, licenseHint.Text) = id switch
            {
                ...
                _ => ("No license connected", "Activation and purchase management will be connected later. Do not enter a real license key into this preview.")
            };
        }
    ...
    {
        var button = new HandCursorButton { Content = label, HorizontalAlignment = HorizontalAlignment.Left, Style = (Style)Application.Current.Resources["SecondaryButtonStyle"] };
