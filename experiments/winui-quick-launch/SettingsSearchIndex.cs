...
internal sealed record SettingSearchEntry(string Category, string Key, string Label, string Description, string Icon, string Keywords = "");

internal static class SettingsSearchIndex
{
    internal static IReadOnlyList<SettingSearchEntry> Find(IEnumerable<SettingSearchEntry> entries, string query)
    {
