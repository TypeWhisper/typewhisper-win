...
public sealed partial class SettingsWindow : Window
{
    ...
    private void ShowCategory(string category)
    {
        ...
        if (catalog)
        {
            ...
            SettingsCatalog.Render(category, CatalogContent, _values, _catalogPickers, () => ShowCategory(category));
            if (category == "General")
            {
    ...
    internal void ShowSetup()
    {
        ...
        SetupHost.Child = new SetupWizard(_values, ExitSetup);
    ...
    private void SettingsSearch_KeyDown(object sender, KeyRoutedEventArgs e)
    {
        ...
        else if (e.Key == Windows.System.VirtualKey.Enter && _searchButtons.FirstOrDefault()?.Tag is SettingSearchEntry entry)
        {
